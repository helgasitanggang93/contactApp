 const messageHandler = {
  ...
  address: {
    ...
    errLengthAddress: 'Length of Address should be greater then 3 and less then 101'
  },
  phoneNumber: {
 ...
 const stringType = {
  imageDefault: 'https://res.cloudinary.com/dpnjbs730/image/upload/v1574910240/no_image_yet_fmxurx.jpg'
}
